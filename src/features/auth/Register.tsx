                    ...
                    >
                        ...
                        <div className="flex justify-center mb-6">
                            <div className="flex items-center gap-2">
                                <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#6324eb] text-white">
                                    <span className="text-2xl">🤟</span>
                                </div>
                                <span className="text-xl font-bold tracking-tight text-white">EnSeñas AI</span>
                            </div>
                        </div>
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-6">
                            <button
                                ...
                                type="button"
                                className="flex items-center justify-center gap-2 h-12 px-4 rounded-lg bg-[#221d2e] border border-zinc-700 hover:bg-zinc-800 transition-colors group"
                            >
                                ...
                                <span className="text-sm font-bold text-white truncate">Google</span>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <span className="text-sm font-bold text-white truncate">Facebook</span>
                            </button>
                        </div>
