            ...
            >
                ...
                <div className="relative z-20 p-12">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-bold tracking-tight">EnSeñas AI</span>
                    </div>
                </div>
                    ...
                    <div className="glass-panel rounded-2xl p-8 md:p-10 w-full">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <button
                                ...
                                type="button"
                                className="flex items-center justify-center gap-2 h-11 rounded-lg border border-white/10 bg-white/5 hover:bg-white/10 transition-colors duration-200 text-white text-sm font-medium"
                            >
